  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.resources:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.pack(pattern, *_v1.sequence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v3.resource = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v3.epoch = str[start:end].decode('utf-8')
        else:
        ...
        _v3.sequence = struct.unpack(pattern, str[start:end])
        ...
        if python3:
          _v4.client_name = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v4.user_name = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v7.resource = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v7.epoch = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v8.client_name = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v8.user_name = str[start:end].decode('utf-8')
        else:
